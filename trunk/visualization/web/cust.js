...
var ndx = crossfilter(measurementData),
    ...
    measurementDim = ndx.dimension(function(d) {
        return Math.floor(d.Measurement / 10);
    }),
    nameDim = ndx.dimension(function(d) {
        return d.Name;
    }),

    measurementPerYear = yearDim.group().reduceSum(function(d) {
        return +d.Measurement;
    }),
    measurementPerMonth = monthDim.group().reduceSum(function(d) {
        return +d.Measurement;
    }),
    measurementPerDay = dayDim.group().reduceSum(function(d) {
        return +d.Measurement;
    }),
    measurementPerHour = hourDim.group().reduceSum(function(d) {
        return +d.Measurement;
    }),

    measurementPerName = nameDim.group().reduceSum(function(d) {
        return +d.Measurement;
    }),
...
waterTreatmentLandngStackedChart.xAxis().tickFormat(function(d) {
    return d * 10
...
waterTreatmentLandngStackedChart1.xAxis().tickFormat(function(d) {
    return d * 10
}); // convert back to base unit
...
waterTreatmentLandngStackedChart2.xAxis().tickFormat(function(d) {
    return d * 10
}); // convert back to base unit
...
waterTreatmentLandngStackedChart3.xAxis().tickFormat(function(d) {
    return d * 10
}); // convert back to base unit
