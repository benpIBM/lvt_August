    ...
    d3.select("#btnOverall")
      .on("click", function() {  
          d3.select("#overall-container").style("display", "block");
          d3.select("#mo-container").style("display", "none");
          ...
          if ((overallParentChart.filters().length | 
              overallChart.filters().length | 
              overallPieChart.filters().length) > 0) {
            dc.redrawAll("overall");
          }
          else {
            dc.renderAll("overall");
          }
    ...
    d3.select("#btnMo")
      .on("click", function() {  
          d3.select("#overall-container").style("display", "none");
          d3.select("#mo-container").style("display", "block");
          d3.select("#revenues-container").style("display", "none");
          d3.select("#targetExpenses-container").style("display", "none");
